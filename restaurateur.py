...
class Franchise():
  ...
  def available_menus(self, time):
    ...
    for menu in self.menus:
      # if menu availability's start time is less than or equal to the current time and the current time is less than or equal to that menu availabilitiy's end time: return menus meeting those criteria
